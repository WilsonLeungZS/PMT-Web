            ...
            <div class="tl-bar-item">
              <el-popover
                ...
                trigger="click">
                  ...
                  <el-row>
                    <el-col :span="12">
                      <el-button type="primary" size="mini" @click="confirmFilterTask">Confirm</el-button>
                    </el-col>
                    <el-col :span="12">
                      <el-button type="primary" size="mini" @click="clearFilterTask">Reset</el-button>
                    </el-col>
                  </el-row>
        ...
        <el-row class="tl-main" v-if="showForLv1AndLv2">
          <el-col :span="24">
            <el-table :row-class-name="mouseClick" @row-click="onRowClick" :row-key="rowKey" v-loading="taskslistLoading" :data="taskslistData" class="tl-main-table" fit empty-text="No Data" :header-cell-style="{'background-color': headerColor, color:'white'}">
              ...
              <el-table-column  prop="task_parent_name" label="Parent Task" width="100px" v-if="!taskListRule.showColForLv1" key="2">
                <template slot-scope="scope">
                   <el-button type="text" @click.stop="openTaskByName(scope.row.task_parent_name)">{{scope.row.task_parent_name}}</el-button>
                </template>
              </el-table-column>
              <el-table-column prop="task_name" label="Number" width="100px" key="3">
                <template slot-scope="scope">
              ...
              <el-table-column prop="task_status" label="Status" align="center" width="100px" v-if="(currentLevel) === 2" key="9">
                <template slot-scope="scope">
              ...
              <el-table-column prop="task_top_team_sizing" label="Team Sizing" show-overflow-tooltip align="center" width="110px" v-if="taskListRule.showColForLv1" key="10"></el-table-column>
              ...
              <el-table-column prop="task_effort" label="Effort" align="center" width="90px" v-if="!taskListRule.showColForLv1" key="13"></el-table-column>
              <el-table-column prop="task_estimation" label="Estimation" align="center" width="120px" v-if="!taskListRule.showColForLv1" key="14"></el-table-column>
              <el-table-column prop="task_responsible_leader" label="Leading By" show-overflow-tooltip align="center" width="180px" key="15">
                <template slot-scope="scope">
              ...
              <el-table-column prop="task_skill" label="Related Skills" show-overflow-tooltip align="center" width="180px" v-if="!taskListRule.showColForLv1" key="18"></el-table-column>
        ...
        <el-tabs v-model="activeTabForLv4" type="card" ref="taskLv4Tabs" @tab-click="((tab, event)=>{changeTab(tab, event, 'taskLv4Form', 'activeTabForLv4')})">
          <el-tab-pane label="Basic Information" name="tab_basic_info">
            ...
            <el-row>
              ...
              <el-col :span="12" :offset="1"  v-if="lv3TaskItemRule.showDeliverableTag" >
                <el-form-item label="Deliverable Tag">
                  <el-select disabled  v-model="taskLv4Form.task_deliverableTag" multiple filterable allow-create default-first-option style="width: 100%">
                    <el-option v-for="item in DeliverOptions" :key="item.value" :label="item.label" :value="item.value"></el-option>
                  </el-select>            
                </el-form-item>
              </el-col>
     ...
     async getTask (iUrl, iCriteria) {
      ...
      if (res.data.status === 0) {
        ...
        if (rtnTask.task_level === 2) {
          ...
          if(this.$data.taskLv2Form.task_skill!=null){
            this.$data.taskLv2Form.task_skill = this.$data.taskLv2Form.task_skill.split(",")
          }
...
        })
    ...
    async saveLv2Task () {
      ...
      if (reqTask != null) {
        ...
        const res2 = await http.post('/tasks/saveSkillToReference', {
          reqTaskSkill: JSON.stringify(reqTask.task_skill)
        })
        if (res.data.status === 0) {
          this.$message({message: 'Task created successfully!', type: 'success'})
        } else {
    ...
    async saveLv3Task () {
      ...
      if(this.$data.taskLv3Form.task_deliverableTag!=null&&typeof(this.$data.taskLv3Form.task_deliverableTag)==='object'){
          this.$data.taskLv3Form.task_deliverableTag = this.$data.taskLv3Form.task_deliverableTag.toString();             
      }
